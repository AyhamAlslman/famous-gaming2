        ...
        <div class="container site-footer-grid site-footer-clean-grid">
            ...
            <div class="site-footer-follow">
                ...
                <div class="site-footer-socials">
                    <a href="https://wa.me/962791234567" class="footer-social footer-whatsapp" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp">
    ...
    <script src="<?php echo htmlspecialchars(site_url('assets/js/script.js'), ENT_QUOTES, 'UTF-8'); ?>?v=2.7"></script>
</body>
</html>
