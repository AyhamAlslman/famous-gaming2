...
if (!$current_site_user) {
    $_SESSION['post_login_redirect'] = 'user_dashboard.php';
    header('Location: login.php?redirect=user_dashboard.php');
    exit;
}
...
<section class="content user-dashboard-content">
    <div class="container">
        <div class="user-dashboard-grid">
            <a class="user-dashboard-stat" href="my_bookings.php">
            ...
            <a class="user-dashboard-stat loyalty-stat" href="my_bookings.php">
                <span><?php echo t('loyalty_points'); ?></span>
                <strong><?php echo (int)$current_site_user['loyalty_points']; ?></strong>
            </a>
            <a class="user-dashboard-stat" href="notifications.php">
        ...
        <div class="user-dashboard-actions">
            <a href="booking.php" class="user-action-card">
                    ...
                    <article class="booking-room-detail-card user-room-card <?php echo $is_available ? 'is-available' : 'is-busy'; ?>">
                        ...
                        <div class="booking-room-detail-body">
                            ...
                            <div class="booking-room-detail-footer">
                                ...
                                <?php if ($is_available): ?>
                                    <a class="btn btn-small" href="booking.php?room_id=<?php echo (int)$room['id']; ?>#booking-form"><?php echo t('home_book_room'); ?></a>
                                <?php else: ?>
            ...
            <?php else: ?>
                <div class="user-bookings-mini-list">
                    <?php foreach ($recent_bookings as $booking): ?>
                        <a href="my_bookings.php" class="user-booking-mini-card">
                            <div>
