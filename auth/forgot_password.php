    ...
    <div class="container">
        <div class="auth-shell auth-shell-compact">
            <div class="auth-card">
                ...
                <form method="POST" action="<?php echo htmlspecialchars(site_url('auth/forgot_password.php'), ENT_QUOTES, 'UTF-8'); ?>" class="auth-form">
                ...
                <div class="auth-links">
                    ...
                    <a href="<?php echo htmlspecialchars(site_url('auth/register.php'), ENT_QUOTES, 'UTF-8'); ?>"><?php echo t('auth_need_account'); ?></a>
            ...
            <aside class="auth-side-panel">
                ...
                <a class="auth-side-action" href="<?php echo htmlspecialchars(site_url('auth/login.php'), ENT_QUOTES, 'UTF-8'); ?>"><?php echo t('nav_login'); ?></a>
            </aside>
            </div>
    </div>
</section>
