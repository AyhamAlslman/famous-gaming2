    ...
    <div class="container">
        <div class="auth-shell">
            <div class="auth-card auth-card-wide">
                ...
                <form method="POST" action="<?php echo htmlspecialchars(site_url('auth/register.php'), ENT_QUOTES, 'UTF-8'); ?>" class="auth-form auth-form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <div class="auth-password-field">
                            ...
                            <button type="button" class="auth-password-toggle" data-password-toggle="#register-password" data-show-label="<?php echo htmlspecialchars(t('auth_show_password'), ENT_QUOTES, 'UTF-8'); ?>" data-hide-label="<?php echo htmlspecialchars(t('auth_hide_password'), ENT_QUOTES, 'UTF-8'); ?>"><?php echo t('auth_show_password'); ?></button>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="auth-password-field">
                            ...
                            <button type="button" class="auth-password-toggle" data-password-toggle="#register-confirm-password" data-show-label="<?php echo htmlspecialchars(t('auth_show_password'), ENT_QUOTES, 'UTF-8'); ?>" data-hide-label="<?php echo htmlspecialchars(t('auth_hide_password'), ENT_QUOTES, 'UTF-8'); ?>"><?php echo t('auth_show_password'); ?></button>
                        </div>
                    </div>
                ...
                <div class="auth-links">
                    <a href="<?php echo htmlspecialchars(site_url('auth/login.php'), ENT_QUOTES, 'UTF-8'); ?>?redirect=<?php echo urlencode($auth_redirect); ?>"><?php echo t('auth_have_account'); ?></a>
                    <a class="auth-forgot-link" href="<?php echo htmlspecialchars(site_url('auth/forgot_password.php'), ENT_QUOTES, 'UTF-8'); ?>"><?php echo t('auth_forgot_password'); ?></a>
            ...
            <aside class="auth-side-panel">
                ...
                <h2><?php echo t('nav_register'); ?></h2>
                <p><?php echo t('auth_password_tip'); ?></p>
                <a class="auth-side-action" href="<?php echo htmlspecialchars(site_url('auth/login.php'), ENT_QUOTES, 'UTF-8'); ?>"><?php echo t('auth_have_account'); ?></a>
            </aside>
            </div>
    </div>
</section>
