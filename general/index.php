...
$booking_login_link = site_url('auth/login.php?redirect=' . urlencode('user/booking.php'));
...
<section class="index-hero-redesign" aria-label="<?php echo htmlspecialchars(t('home_hero_title'), ENT_QUOTES, 'UTF-8'); ?>">
    <div class="container index-hero-layout">
        ...
        <div class="index-hero-media" aria-hidden="true">
            <img src="<?php echo htmlspecialchars(site_url('images/home-hero-2026.png'), ENT_QUOTES, 'UTF-8'); ?>" alt="">
        </div>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="home-service-grid home-service-grid-three">
            <a href="<?php echo htmlspecialchars($is_logged_in ? site_url('user/booking.php') : $booking_login_link, ENT_QUOTES, 'UTF-8'); ?>" class="home-service-card home-service-card-large">
                <img src="<?php echo htmlspecialchars(site_url('images/home-game-collage.jpg'), ENT_QUOTES, 'UTF-8'); ?>" alt="<?php echo htmlspecialchars(t('home_book_card_title'), ENT_QUOTES, 'UTF-8'); ?>">
                <div>
            ...
            <a href="#home-menu-preview" class="home-service-card home-service-card-large" data-home-menu-trigger>
                <img src="<?php echo htmlspecialchars(site_url('images/service-food.png'), ENT_QUOTES, 'UTF-8'); ?>" alt="<?php echo htmlspecialchars(t('home_snacks_card_title'), ENT_QUOTES, 'UTF-8'); ?>">
                <div>
                    <span><?php echo t('services_hospitality_type'); ?></span>
            ...
            <a href="<?php echo htmlspecialchars(site_url('user/store.php'), ENT_QUOTES, 'UTF-8'); ?>" class="home-service-card home-service-card-large">
                <img src="<?php echo htmlspecialchars(site_url('images/store.jpg'), ENT_QUOTES, 'UTF-8'); ?>" alt="<?php echo htmlspecialchars(t('home_store_card_title'), ENT_QUOTES, 'UTF-8'); ?>">
                <div>
                    <span><?php echo t('nav_store'); ?></span>
        ...
        <div class="home-menu-preview home-menu-preview-panel" id="home-menu-preview" data-home-menu-panel hidden>
            ...
            <?php if (!$is_logged_in): ?>
                <div class="home-menu-login-note">
                    ...
                    <a href="<?php echo htmlspecialchars(site_url('auth/register.php?redirect=' . urlencode('user/booking.php')), ENT_QUOTES, 'UTF-8'); ?>" class="btn btn-small home-secondary-btn"><?php echo t('nav_register'); ?></a>
                </div>
            <?php endif; ?>
        </div>
    </div>
