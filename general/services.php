...
<section class="content">
    <div class="container">
        <div class="services-amenities-section">
            ...
            <div class="row g-4 services-grid">
                <div class="col-12 col-md-6 col-lg-4">
                    ...
                    >
                        <div class="service-image" data-card-media>
                            <img src="<?php echo htmlspecialchars(site_url('images/service-gaming.png'), ENT_QUOTES, 'UTF-8'); ?>" alt="<?php echo htmlspecialchars(t('services_gaming_type'), ENT_QUOTES, 'UTF-8'); ?>" class="img-fluid">
                        </div>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    ...
                    >
                        <div class="service-image" data-card-media>
                            <img src="<?php echo htmlspecialchars(site_url('images/service-food.png'), ENT_QUOTES, 'UTF-8'); ?>" alt="<?php echo htmlspecialchars(t('services_hospitality_type'), ENT_QUOTES, 'UTF-8'); ?>" class="img-fluid">
                        </div>
                        <div class="service-card-content">
        ...
        <div class="services-cta-container">
            <a href="<?php echo htmlspecialchars(site_url('user/booking.php'), ENT_QUOTES, 'UTF-8'); ?>" class="btn services-cta-btn"><?php echo t('services_cta'); ?></a>
        </div>
    </div>
</section>
