        ...
        <?php if (!$booking): ?>
            <div class="booking-lookup-panel">
                ...
                <div class="booking-ticket-actions">
                    ...
                    <a href="<?php echo htmlspecialchars(site_url('user/booking.php'), ENT_QUOTES, 'UTF-8'); ?>" class="btn payment-secondary-btn"><?php echo t('payment_new_booking'); ?></a>
                </div>
            </div>
        <?php else: ?>
                ...
                <div class="checkout-panel checkout-form-panel">
                    ...
                    <?php if (($booking['payment_status'] ?? 'Unpaid') === 'Paid'): ?>
                        <div class="payment-success-panel">
                            ...
                            <div class="booking-ticket-actions">
                                <a href="<?php echo htmlspecialchars(site_url('user/my_bookings.php'), ENT_QUOTES, 'UTF-8'); ?>" class="btn"><?php echo t('common_back_to_my_bookings'); ?></a>
                            </div>
                        </div>
                    ...
                    <?php else: ?>
                        <form method="POST" action="<?php echo htmlspecialchars(site_url('user/payment.php?booking_id=' . (int)$booking['id']), ENT_QUOTES, 'UTF-8'); ?>" class="checkout-form">
